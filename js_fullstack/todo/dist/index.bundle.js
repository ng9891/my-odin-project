...
const TodosUI = (() => {
  ...
  const _render = () => {
    ...
    const span = (0,_helper_helper__WEBPACK_IMPORTED_MODULE_4__.createImgButton)({
    ...
    const title = (0,_helper_helper__WEBPACK_IMPORTED_MODULE_4__.createWrappingDiv)('projTitle', divChildren);
  ...
  const createTodoElement = ({title, due, priority, completed, project}) => {
    const projName = (0,_helper_helper__WEBPACK_IMPORTED_MODULE_4__.createInput)({type: 'hidden', value: project})[0];
    const projNameDiv = (0,_helper_helper__WEBPACK_IMPORTED_MODULE_4__.createWrappingDiv)('projName', [projName]);
    ...
    const projInfoDiv = (0,_helper_helper__WEBPACK_IMPORTED_MODULE_4__.createWrappingDiv)('proj');
    ...
    const dueTxt = !due ? 'No due' : (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(due.replace(/-/g, '/')), 'MMM dd');
    ...
    const item = (0,_helper_helper__WEBPACK_IMPORTED_MODULE_4__.createWrappingDiv)('item', [projNameDiv, checkboxDiv, titleDiv, projInfoDiv, dateDiv, deleteBtn]);
...
const GeneralTabsUI = (() => {
  ...
  const _render = () => {
    _helper_pubsub__WEBPACK_IMPORTED_MODULE_0__["default"].publish('generalTabsUpdate');
  };
  ...
  const calcProjects = function calcDailyWeeklyProjects() {
    ...
    const tomorrow = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(today, {days: 1});
    const weekLater = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(today, {weeks: 1});
    for (const [key, project] of projectsMap.entries()) {
      ...
      tasksArr.forEach((task) => {
        ...
        if (due) {
          ...
          const laterThanToday = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(due, tomorrow) >= 0;
          const earlierThanAWeekLater = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(due, weekLater) <= 0;
          if (laterThanToday && earlierThanAWeekLater) newWeeklyProj.addTodo(task, false);
          if ((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(due, today) >= 0 && (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(due, tomorrow) < 0) newDailyProj.addTodo(task, false);
        }
      });
    }
...
const main = () => {
  ...
  const test = (0,_Todo__WEBPACK_IMPORTED_MODULE_2__["default"])({title: 'testTodo', desc: 'testDesc', priority: 1, due: '2022-05-05'});
  testProj.addTodo(test);
  // home.addTodo(test);

  const test2 = (0,_Todo__WEBPACK_IMPORTED_MODULE_2__["default"])({title: 'testTodo2', desc: 'testDesc', priority: 3, due: '2022-05-09'});
  testProj.addTodo(test2);
  // home.addTodo(test2);

  const test3 = (0,_Todo__WEBPACK_IMPORTED_MODULE_2__["default"])({title: 'testTodo3', desc: 'testDesc', priority: 2, due: '2022-05-13'});
  testProj.addTodo(test3);
  // home.addTodo(test3);

  const test4 = (0,_Todo__WEBPACK_IMPORTED_MODULE_2__["default"])({title: 'testTodo444 4444 44444', desc: 'testDesc', priority: 2});
  testProj.addTodo(test4);
  // home.addTodo(test4);

  const test5 = (0,_Todo__WEBPACK_IMPORTED_MODULE_2__["default"])({title: 'testTodo444 4444 444444', desc: 'testDesc', priority: 2, due: '2022-05-06'});
